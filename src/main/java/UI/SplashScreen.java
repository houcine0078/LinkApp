...
public class SplashScreen extends JWindow {
    ...
    private double durationMultiplier = 1.0; // 1.0 = normal speed
    ...
    private String customLoadingMessage = null;
    ...
    // New constructor for custom loading message
    public SplashScreen(String loadingMessage) {
        this();
        this.customLoadingMessage = loadingMessage;
        if (loadingMessage != null && !loadingMessage.isEmpty()) {
            this.loadingMessages = new String[]{loadingMessage};
            this.currentMessageIndex = 0;
        }
    }

    // New constructor for custom loading message and speed
    public SplashScreen(String loadingMessage, double durationMultiplier) {
        this(loadingMessage);
    ...
    public void showSplashWithProgress() {
        ...
        for (int i = 0; i <= 50; i++) {
            ...
            repaint();
            sleep((int)(8 * durationMultiplier));
        }
        ...
        for (int i = 0; i <= 100; i++) {
            ...
            repaint();
            sleep((int)(25 * durationMultiplier));
        }

        // Hold for a moment
        sleep((int)(300 * durationMultiplier));
